...
MARKER='# added by claude-local install.sh'
...
echo "       task-init claude-local"
echo "     (creates tasks/ directory, .claude/local-workflow.md, and slash commands)"
sleep 0.4
echo ""
echo "  2. Start Claude and kick off the PM agent:"
echo "       claude"
echo "     then type /pm"
echo ""
